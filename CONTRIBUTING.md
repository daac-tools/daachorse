...
- Using LLMs and similar tools to circumvent the copyright or license
  obligations attached to others' works is not permitted. If you contribute code
  that has been translated, modified, or transformed by an LLM based on someone
  else's work, please clearly indicate the source.
