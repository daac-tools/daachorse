...
- Using LLMs to launder intellectual property contained in others' copyrighted
  works is not permitted. If you contribute code that has been translated,
  modified, or transformed by an LLM based on someone else's work, please
